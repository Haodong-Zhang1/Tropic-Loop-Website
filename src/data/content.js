...
export const copy = {
  zh: {
    home: {
      ...
      allNews: "查看全部 JCU 新闻",
      newsUpdated: "内容更新于 2026 年 9 月 13 日",
      exploreTitle: "从校园开始",
  ...
  en: {
    home: {
      ...
      newsUpdated: "Content updated 13 September 2026",
...
export const campusNews = [
  ...
  {
    id: "enrolment-drop-ins-cairns-townsville-2026",
    campus: "both",
    date: "2026-09-07",
    dateLabel: { zh: "9 月 7–18 日 · 每天 10:00–13:00", en: "7–18 Sep · daily 10am–1pm" },
    category: { zh: "选课与学业支持", en: "Enrolment and study support" },
    title: { zh: "选课与培养计划现场支持：Student Centre 无需预约", en: "Enrolment drop-in support: no appointment needed" },
    summary: { zh: "可到所在校区的 Student Centre 咨询选课、study plan、转专业、学分与先修课豁免；活动期间每天开放，无需预约。", en: "Visit your campus Student Centre for help with enrolment, study plans, credit, course changes and requisite waivers. Drop-ins run daily with no appointment needed." },
    url: "https://www.jcu.edu.au/students/enrolment",
  },
];
