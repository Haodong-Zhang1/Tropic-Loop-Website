...
export const copy = {
  zh: {
    home: {
      ...
      allNews: "查看全部 JCU 新闻",
      newsUpdated: "内容更新于 2026 年 8 月 24 日",
      exploreTitle: "从校园开始",
  ...
  en: {
    home: {
      ...
      newsUpdated: "Content updated 24 August 2026",
...
export const campusNews = [
  ...
  {
    id: "spark-townsville-2026",
    campus: "townsville",
    date: "2026-08-28",
    dateLabel: { zh: "8 月 28 日 · 11:30–13:00", en: "28 Aug · 11:30am–1pm" },
    category: { zh: "即将开始", en: "Upcoming" },
    title: { zh: "SPARK：与 JCU 优秀校友面对面聊职业发展", en: "SPARK: meet JCU alumni and explore career pathways" },
    summary: { zh: "汤斯维尔校区免费活动，面向在校生、教职工与校友；包含轻午餐、校友职业分享和现场提问。", en: "A free Townsville event for current students, staff and alumni, with a light lunch, alumni career stories and live Q&A." },
    url: "https://www.jcu.edu.au/events/2026/august/spark-students-and-professionals-aligning%2C-relating%2C-and-knowledge-sharing",
  },
  {
    id: "lets-lunch-2026",
    campus: "both",
    date: "2026-08-27",
    dateLabel: { zh: "8 月 27 日 · 12:00–13:00", en: "27 Aug · 12–1pm" },
    category: { zh: "即将开始", en: "Upcoming" },
    title: { zh: "Let's Lunch：免费午餐与多元文化校园交流", en: "Let's Lunch: free food and multicultural campus connections" },
    summary: { zh: "凯恩斯 A1 学生中心草坪与汤斯维尔 143 楼 Central Plaza 同步举行，面向 JCU 在校生。", en: "Open to current students at the A1 Student Centre Lawns in Cairns and Central Plaza, Building 143, in Townsville." },
    url: "https://www.jcu.edu.au/events/2026/august/lets-lunch-multicultural-queensland-month",
  },
  {
    id: "study-break-2027",
    campus: "both",
    date: "2026-08-12",
    dateLabel: { zh: "8 月 12 日发布", en: "Published 12 Aug" },
    category: { zh: "学业政策", en: "Study update" },
    title: { zh: "JCU 2027 年每个 trimester 将恢复至少 5 天考前复习期", en: "JCU will add a five-day study break before each 2027 trimester exam period" },
    summary: { zh: "教学周仍为 10 周，考试安排在周四至周六；调整来自学生对考前准备时间的反馈。", en: "Teaching remains at 10 weeks, with exams running Thursday to Saturday; the change responds to student feedback on exam preparation time." },
    url: "https://www.jcu.edu.au/news/releases/2026/august/jcu-to-deliver-study-break-for-2027-trimesters",
  },
];
