...
export const copy = {
  zh: {
    home: {
      ...
      allNews: "查看全部 JCU 新闻",
      newsUpdated: "内容更新于 2026 年 9 月 16 日",
      exploreTitle: "从校园开始",
  ...
  en: {
    home: {
      ...
      newsUpdated: "Content updated 16 September 2026",
...
export const campusNews = [
  ...
  {
    id: "networking-101-linkedin-cairns-2026",
    campus: "cairns",
    date: "2026-09-23",
    dateLabel: { zh: "9 月 17 日或 23 日 · 12:00", en: "17 or 23 Sep · 12pm" },
    ...
    summary: { zh: "在凯恩斯校区 D003-059 任选一场，学习建立职业联系和优化 LinkedIn 主页；需通过 JCU CareerHub 预约。", en: "Choose a session in Cairns room D003-059 to practise professional networking and strengthen your LinkedIn profile; booking is through JCU CareerHub." },
