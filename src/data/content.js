...
export const copy = {
  zh: {
    home: {
      ...
      allNews: "查看全部 JCU 新闻",
      newsUpdated: "首批内容更新于 2026 年 8 月 18 日",
      exploreTitle: "从校园开始",
  ...
  en: {
    home: {
      ...
      newsUpdated: "Initial selection updated 18 August 2026",
...
export const campusNews = [
  {
    id: "research-festival-2026",
    campus: "both",
    date: "2026-08-10",
    dateLabel: { zh: "8 月 10–28 日", en: "10–28 Aug" },
    category: { zh: "正在进行", en: "Happening now" },
    title: { zh: "JCU Research Festival 连接研究、产业与学生", en: "JCU Research Festival connects research, industry and students" },
    summary: { zh: "凯恩斯、汤斯维尔和线上活动涵盖研究展示、3MT、产业交流与科研沟通工作坊。", en: "Events across Cairns, Townsville and online include research showcases, 3MT, industry networking and research communication workshops." },
    url: "https://www.jcu.edu.au/b/research-festival",
  },
  {
    id: "cairns-open-day-2026",
    campus: "cairns",
    date: "2026-07-23",
    dateLabel: { zh: "7 月 23 日", en: "23 Jul" },
    category: { zh: "凯恩斯", en: "Cairns" },
    title: { zh: "JCU 凯恩斯开放日展示校园学习与研究空间", en: "Cairns Open Day showcased JCU study and research spaces" },
    summary: { zh: "Nguma-bada 校区开放教学设施、Ideas Lab CAVE、住宿和学习空间供学生与社区参观。", en: "The Nguma-bada campus opened its teaching facilities, Ideas Lab CAVE, accommodation and learning spaces to students and the community." },
    url: "https://www.jcu.edu.au/news/releases/2026/july/discover-life-at-jcu-during-cairns-open-day",
  },
  {
    id: "townsville-aged-care-partnership-2026",
    campus: "townsville",
    date: "2026-07-21",
    dateLabel: { zh: "7 月 21 日", en: "21 Jul" },
    category: { zh: "汤斯维尔", en: "Townsville" },
    title: { zh: "JCU 实习合作为学生打开老年照护职业路径", en: "JCU placement partnership opens aged-care career pathways" },
    summary: { zh: "JCU 与 Good Shepherd Home 的合作把课程实习、循证训练与本地就业连接起来。", en: "JCU's partnership with the Good Shepherd Home connects placements and evidence-based training with local employment." },
    url: "https://www.jcu.edu.au/news/releases/2026/july/jcu-partnership-strengthens-residential-aged-care-in-north-queensland",
  },
  {
    id: "townsville-coastal-summit-2026",
    campus: "townsville",
    date: "2026-07-20",
    dateLabel: { zh: "7 月 20 日", en: "20 Jul" },
    category: { zh: "汤斯维尔", en: "Townsville" },
    title: { zh: "全球海岸修复峰会走进 Bebegu Yumba 校区", en: "Global coastal restoration summit came to Bebegu Yumba" },
    summary: { zh: "科学家、政策制定者与原住民领袖在汤斯维尔讨论湿地、水质与气候韧性的实践方案。", en: "Scientists, policymakers and Indigenous leaders met in Townsville to advance practical work on wetlands, water quality and climate resilience." },
    url: "https://www.jcu.edu.au/news/releases/2026/july/global-summit-on-coastal-wetland-and-water-quality-in-townsville",
  },
  {
    id: "yeinie-building-open-2026",
    campus: "cairns",
    date: "2026-07-16",
    dateLabel: { zh: "7 月 16 日", en: "16 Jul" },
    category: { zh: "凯恩斯", en: "Cairns" },
    title: { zh: "凯恩斯 Yeinie Building 正式启用", en: "Cairns Yeinie Building officially opened" },
    summary: { zh: "新设施服务护理、医学高年级和助产教学，设有临床教学室、模拟病房与共享学习空间。", en: "The new facility supports Nursing, senior Medicine and Midwifery with clinical teaching rooms, simulation wards and shared learning spaces." },
    url: "https://www.jcu.edu.au/news/releases/2026/july/jcu-officially-opens-yeinie-building-in-milestone-for-northern-health-education",
  },
];
