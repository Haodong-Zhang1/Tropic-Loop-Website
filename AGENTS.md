...
## Cairns Loop visual decisions

- Treat `design/selected-homepage.png` as the selected visual source of truth.
- Preserve the Cairns Loop name and minimal continuous-loop brand mark.
- Prefer softer humanist Chinese typography and medium weights; avoid heavy, square administrative-portal styling.
- The homepage uses real JCU Cairns Campus, Ideas Lab and John Grey Hall photography with source links. Do not imply that Cairns Loop is an official JCU product.
